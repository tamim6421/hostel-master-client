...
const ContactUs = () => {
    return (
        <div className=" pt-20">
         ...
         <h1 className="text-3xl font-bold text-center my-10 text-blue-500"> Contact With Us</h1>
        ...
        <div className="card  "  data-aos="fade-down">
          ...
          <BiSolidPhoneCall className="text-5xl text-blue-500"></BiSolidPhoneCall>
          </figure>
          <div className="card-body items-center text-center">
            <h2 className="card-title text-blue-500">Call Us</h2>
            <p>+987 092 291 091</p>
        ...
        <AiTwotoneMail className="text-5xl  text-blue-500"></AiTwotoneMail>
          </figure>
          <div className="card-body items-center text-center">
          
            <h2 className="card-title text-blue-500">Connect With Email</h2>
        ...
        <div className="card"  data-aos="fade-up">
          <figure className="px-10 pt-10">
         <FaLocationDot className="text-5xl  text-blue-500"></FaLocationDot>
          </figure>
          <div className="card-body items-center text-center">
            <h2 className="card-title text-blue-500">Our Office Location</h2>
      ...
      <p className="text-4xl text-center text-gray-500 font-semibold mt-36 mb-12 " data-aos="fade-down">
        ...
        <div className="hero min-h-screen">
          <div className="hero-content  flex-col lg:flex-row-reverse">
            <div className="text-center  lg:text-left" data-aos="fade-up" >
              <img src="https://i.ibb.co/mbhGV8V/pexels-pixabay-260922.jpg" alt=""  className="rounded-lg w-3/4 mx-auto " />
            </div>
            <div className="card flex-shrink-0 w-full max-w-sm ">
              <form className="card-body" data-aos="fade-down" >
                <div className="form-control">
                  <label className="label">
                    <span className="label-text text-blue-500 text-lg">Name</span>
                  </label>
                  <input
                    type="email"
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text text-blue-500  text-lg">Email</span>
                  </label>
                  <input
                    type="email"
                ...
                <div className="form-control mt-6">
                  <button className="btn text-white bg-blue-500 hover:bg-blue-600">Submit</button>
                </div>
              </form>
            </div>
          </div>
        ...
        <hr className=" border-2 w-24 mt-2 border-orange-500 mx-auto" data-aos="fade-up"  />
          ...
          <div className="grid gap-6 grid-cols-1 md:grid-cols-3 ">
            <div className="card  " data-aos="fade-down">
              <figure className="px-10 pt-10">
              <MdOutlineHomeWork className="text-5xl text-blue-500"></MdOutlineHomeWork>
              </figure>
